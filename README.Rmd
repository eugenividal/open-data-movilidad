...
This repository contains code to access transport data (based on the location of mobile phones) from the Ministry of Transport, Mobility and Urban Agenda (Spain). 

The raw data and some information on the method used can be found in the link below. (Do not use Chromium to open the link, you won't be able to see the data!)
